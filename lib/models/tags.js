...
/**
 * Finds a tag by `slug`
 * `cb` is passed with the matching tag, or exceptions.NotFound if the `slug` is not found in the database
 *
 * @param {String} slug
 * @param {Function} cb
 */
...
/**
 * Finds a tag by `id`
 * `cb` is passed with the matching tag, or exceptions.NotFound if the `id` is not found in the database
 *
 * @param id
 * @param cb
 */
...
/**
 * Updates tag with `id`
 * `cb` is passed with the updated tag, or exceptions.NotFound if the `id` is not found in the database
 *
 * @param {Number} id
 * @param {Object} body
 * @param {Function} cb
...
/**
 * Counts tags
 * `cb` is passed with the number of rows
 *
 * @param {Function} cb
 */
...
function count(cb) {
  query('SELECT count(id) FROM tags', function(err, r) {
