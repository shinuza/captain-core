 ...
 * if(err.code == 'ENOTFOUND') {
        return 'Failure: Address not found!<br>' +
                    'Please go back and verify your URI.';
    } else if(err && err.code) {
            return 'Failure: Unable to write configuration<br>' +
                    'Please verify you have write permission to the project folder';
    } else {
        return 'Failure: Cannot connect';
    }
 */
